<?php
    if (isset($_SESSION['pb'])) {
        ...
        echo "<h3 class='sub-header position-relative' style='font-family:Poppins-semibold'>Catatanku <button type='button' onclick=\"window.location.href='tambah_catatan';\" class='btn btn-success btn-sm position-absolute end-0'>Tambah</button> </h3>";
