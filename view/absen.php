...
echo 	"<tr>
        ...
        <td><button type='button' class='btn btn-primary btn-sm' onclick=\"window.location.href='./model/proses.php?absen=1';\" $disable_in>Absen Masuk</button></td>
        <td><button type='button' class='btn btn-danger btn-sm' onclick=\"window.location.href='./model/proses.php?absen=2';\" $disable_out>Absen Pulang</button></td>
        </tr>";
echo "</table></div>";
?>