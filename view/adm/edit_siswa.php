<?php 
  ...
  <div class="form-group mb-2">
    ...
    <div class="col-sm-10">
        ...
        for ($i=0; $i<= $sum ; $i++) { 
            ...
            echo '<label class="radio-inline me-2"><input type="radio" class="me-1" name="jk" id="jk" value="'.$jk_vl[$i].'" '.$checked.'>'.$jk[$i].'</label>';
        }
         ?>
    </div>
  </div>
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-primary btn-sm" name="edit_siswa">Simpan</button>
      <button type="button" onclick="hapusSiswa(<?php echo $id_user; ?>)" class="btn btn-sm btn-danger" name="">Hapus Siswa</button>
    </div>
  </div>
</form>
<?php
